package com.averysk.libraryrefresh.header;
...
import com.averysk.libraryrefresh.header.listener.OnTwoLevelListener;
...
public class TwoLevelHeader extends SimpleComponent implements RefreshHeader, NestedScrollingParent2 {
    ...
    public TwoLevelHeader(Context context, @Nullable AttributeSet attrs) {
        ...
        mEnableRefresh = ta.getBoolean(R.styleable.TwoLevelHeader_srlEnableRefreshTwo, mEnableRefresh);
