package com.averysk.libraryrefresh;
...
import com.averysk.libraryrefresh.api.RefreshContent;
import com.averysk.libraryrefresh.api.RefreshFooter;
import com.averysk.libraryrefresh.api.RefreshHeader;
import com.averysk.libraryrefresh.api.RefreshKernel;
import com.averysk.libraryrefresh.api.RefreshLayout;
import com.averysk.libraryrefresh.constant.DimensionStatus;
...
import com.averysk.libraryrefresh.listener.DefaultRefreshInitializer;
import com.averysk.libraryrefresh.listener.OnLoadMoreListener;
import com.averysk.libraryrefresh.listener.OnMultiListener;
import com.averysk.libraryrefresh.listener.OnRefreshListener;
import com.averysk.libraryrefresh.listener.OnRefreshLoadMoreListener;
import com.averysk.libraryrefresh.listener.OnStateChangedListener;
import com.averysk.libraryrefresh.listener.ScrollBoundaryDecider;
import com.averysk.libraryrefresh.simple.SimpleBoundaryDecider;
import com.averysk.libraryrefresh.util.SmartUtil;
import com.averysk.libraryrefresh.wrapper.RefreshContentWrapper;
import com.averysk.libraryrefresh.wrapper.RefreshFooterWrapper;
import com.averysk.libraryrefresh.wrapper.RefreshHeaderWrapper;
...
import static com.averysk.libraryrefresh.util.SmartUtil.dp2px;
import static com.averysk.libraryrefresh.util.SmartUtil.fling;
import static com.averysk.libraryrefresh.util.SmartUtil.isContentView;
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void moveSpinnerInfinitely(float spinner) {
         ...
         *
         * 2.XML关闭
         *          <com.averysk.libraryrefresh.SmartRefreshLayout
...
//                    break;
        ...
        /**
         * 移动滚动 Scroll
         * moveSpinner 的取名来自 谷歌官方的 { androidx.v4.widget.SwipeRefreshLayout#moveSpinner(float)}
         * moveSpinner The name comes from { androidx.v4.widget.SwipeRefreshLayout#moveSpinner(float)}
         *
